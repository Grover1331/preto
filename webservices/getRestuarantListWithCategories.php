...
if($userID != "" || $language !="") {
	...
	if(empty($author_obj)) {
		$json = array("success"=> 0,"result"=> 0 ,"error"=>"Invalid User");
			...
			$category = get_term_by('id', '11', 'restaurant_category');
			$paged = ( get_query_var('page') ) ? get_query_var('page') : 1;
			query_posts( array (  'post_type' => 'restaurants','restaurant_category' => $category->slug, 'lang' => $language ,'posts_per_page' => 20 , 'paged' => $offSet) ); 
